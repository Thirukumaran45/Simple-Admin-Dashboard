      ...
      appBar: AppBar(
        ...
        leading: Row(
          children: [
            ...
            const Text(
              " Student Bonafide Certificate Form",
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(
                              parentNameController, "Parent's Name"),
                          _buildDateField(
                              dobController, "Date of Birth (DD/MM/YYYY)"),
                          if (selectedOption == "Current Academic") ...[
                            _buildTextField(
                                classController, "Current Class"),
                            _buildTextField(
                                yearController, "Academic Year"),
                          ],
                          _buildTextField(
                              reasonController, "Reason for Bonafide"),
                        ],
                      ),
                    ),
                  ],
