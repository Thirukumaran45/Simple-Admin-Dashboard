                        ...
                        cells: [
                          ...
                          DataCell(
                            ElevatedButton(
                              ...
                              onPressed: () {
                                Beamer.of(context).beamToNamed('/fees-updation/sectionWiseFeesUpdation/studentFeesList/studentFeesUpdation?classNumber=${widget.stuClass}&sectionName=${widget.section}&name=${student['name']!}');
                              },
                              child: const Row(
