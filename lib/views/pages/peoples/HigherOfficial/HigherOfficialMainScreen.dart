        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                customProfileCard(title: "View Higher Officials Details", assetLink: "assets/images/officials.jpg", onpresee: () { Beamer.of(context).beamToNamed('/manage-higher-official/viewHigherOfficailDetails');}),
