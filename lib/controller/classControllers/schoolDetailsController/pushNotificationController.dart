...
@override
 ...
 final serviceAccountJson = {
  ...
  throw PushNotificationException("$e Erron in getting server key, please try again later !");
}
  }
...
Map<String, dynamic> payload = {
  "message": {
    ...
    throw PushNotificationException('$e Error in push notification , please try again later !');
  }
}
...
Future<void> feeUpdationPushNotificationToAll(dynamic context) async {
  ...
  for (var doc in docs.docs) {
    ...
    throw PushNotificationException('$e Error in fees push notification to all, please try again later !');
...
Future<void> feeUpdationPushNotificationToSpecific(dynamic context,{required String id}) async {
  ...
  final docs = await collectionVariable.studentLoginCollection.doc(id).get();
    ...
    final data = docs.data() as Map<String,dynamic>;
      ...
      throw PushNotificationException('$e Error in fees push notification to student, please try again later !');
...
Future<void> examFeesUpdationPushNotification(dynamic context,{required String id}) async {
  ...
  final data = docs.data() as Map<String,dynamic>;
    ...
    if (token != null && token.isNotEmpty) {
      ...
      throw PushNotificationException('$e Error in exam update push notification to student, please try again later !');
